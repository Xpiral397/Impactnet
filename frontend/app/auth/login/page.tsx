    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      >
        ...
        <div className="absolute bottom-12 left-12 right-12 text-white">
          <h2 className="text-4xl font-bold mb-4">Transform Lives Through Education</h2>
          <p className="text-lg text-white/90">Join thousands of students and educators making a difference.</p>
        </div>
      </motion.div>
